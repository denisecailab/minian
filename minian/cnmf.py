...
def update_spatial(
    ...
    Args:
        ...
        f ([type]): [description]
        sn ([type]): [description]
        gs_sigma (int, optional): [description]. Defaults to 6.
        ...
        post_scal (bool, optional): [description]. Defaults to False.
        normalize (bool, optional): [description]. Defaults to True.
        zero_thres (str, optional): [description]. Defaults to 'eps'.
        sched (str, optional): [description]. Defaults to 'single-threaded'.
...
def update_temporal(
    ...
    Args:
        ...
        C ([type]): [description]
        f ([type]): [description]
        sn_spatial ([type]): [description]
        YrA ([type], optional): [description]. Defaults to None.
        ...
        use_spatial (bool, optional): [description]. Defaults to False.
        sparse_penal (int, optional): [description]. Defaults to 1.
        ...
        sched (str, optional): [description]. Defaults to 'processes'.
